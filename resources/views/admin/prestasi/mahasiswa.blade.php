...
@section('title', 'Prestasi Mahasiswa - Admin')
@section('page-title', 'Prestasi Mahasiswa')
@section('page-desc', 'Rekap seluruh prestasi mahasiswa.')
                    ...
                    <tbody>
                            ...
                            @foreach ($prestasi->mahasiswa as $mahasiswa)
                                ...
                                <tr class="border-t"
                                    ...
                                    <td class="p-3 text-center">
                                        <a
                                            href="{{ route('admin.prestasi.mahasiswa.show', $prestasi->id) }}"
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                >
                                    Belum ada prestasi mahasiswa yang tercatat.
                                </td>
                            </tr>

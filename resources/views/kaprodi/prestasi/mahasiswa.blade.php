...
@section('title', 'Prestasi Mahasiswa - Kaprodi')
@section('page-title', 'Prestasi Mahasiswa')
@section('page-desc', 'Rekap prestasi mahasiswa Program Studi.')
                    ...
                    <tbody>
                            ...
                            @foreach ($prestasi->mahasiswa as $mahasiswa)
                                ...
                                <tr class="border-t"
                                    ...
                                    <td class="p-3 text-center">
                                        ...
                                        <a
                                            href="{{ route('kaprodi.prestasi.mahasiswa.show', $prestasi->id) }}"
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                >
                                    Belum ada prestasi mahasiswa pada Program Studi ini.
                                </td>

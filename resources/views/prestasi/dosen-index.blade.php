...
@section('content')
    <div class="flex justify-end mb-4">
        <a href="{{ route('prestasi-dosen.create') }}" class="inline-block px-4 py-2 rounded-xl text-sm font-medium text-white" style="background: var(--primary);">+ Tambah Prestasi</a>
    </div>
    <div class="rounded-2xl border overflow-hidden" style="background: var(--card); border-color: var(--border);">
        <table class="w-full text-left text-sm">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="4" class="p-6 text-center" style="color: var(--muted-foreground);">Belum ada prestasi.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
